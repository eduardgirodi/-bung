...
main(int argc,
    ...
    /*
    ** First variant to read in the fp number
    */
    printf("Floating point number, please: ");
    scanf("%f", &f);

    /*
    ** Second variant to read in the fp number
    */
#if 0
    if (argc == 2 ) {
        sscanf(argv[1], "%f", &f);
    } else {
        fprintf(stderr, "Not enough command line parameters. Exit.\n");
        return -1;
    }
#endif 

    /*
    ** Third variant to read in the fp number
    */
#if 0    
    if (argc == 2 ) {
        f = atof(argv[1]);
